...
---------------
  ...
  The options are:
    ...
    style_html(html_source, {
      ...
      'max_char': 78,
      'brace_style': 'expand',
      'unformatted': ['a', 'b', 'button', 'sub', 'sup', 'b', 'i', 'u']
    });
*/
...
//Wrapper function to invoke all the necessary constructors and deal with the output.
  ...
  unformatted = options.unformatted || ['a', 'b', 'button', 'code', 'dd', 'del', 'dl', 'dt', 'details', 'em', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'sub', 'sup', 'b', 'i', 'u', 'img', 'input', 'ins', 'span', 'small', 'strong', 'style', 'title', 'td', 'th'];
